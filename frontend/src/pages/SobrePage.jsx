        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6 border border-gray-200">
              <blockquote className="text-lg text-muted-foreground  border-l-4 border-azul pl-4">
                <p className="mb-4">
                  <span className="text-azul font-semibold">Cidade Unida</span>{" "}
                  é um projeto desenvolvido por estudantes de
                ...
                <p>
                  ...
                  de denúncias relacionadas à infraestrutura, meio ambiente e
                  serviços públicos.
                </p>
              </blockquote>
            </div>
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-azul mb-8 text-center">
              Nossa Equipe
            </h2>
          ...
          <div className="bg-cinza/20 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-azul mb-4 text-center">
              Nosso Compromisso
            </h2>
            <p className="text-center text-muted-foreground">
              Estamos comprometidos com a transparência, acessibilidade e
              eficiência na resolução de problemas urbanos. O Cidade Unida é
              mais que um projeto acadêmico - é uma iniciativa que busca
              melhorar a qualidade de vida nas cidades através da tecnologia e
              participação cidadã.
            </p>
          </div>
        </div>
